define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
	...
	function stiatExtension(options)
	{
		...
		var stiatObj =
		{
			...
			category :
			{
				name : 'Government', //Category name to be used for feedback and logging.
				title : {
			...
			attribute1 :
			{
				name : 'Untrustworthy', //Attribute name to be used for feedback and logging
				title : {
			...
			attribute2 :
			{
				name : 'Trustworthy', //Attribute name to be used for feedback and logging
				title : {
